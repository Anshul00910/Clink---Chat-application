  ...
  {chat.map((msg, index) => (
    <div
      ...
      style={{
        ...
        marginLeft: msg.userName === userName ? 'auto' : '0', // Align right for sender
        marginRight: msg.userName === userName ? '0' : 'auto', // Align left for receiver
      }}
    >
      <div
        style={{
      ...
      >
        ...
        <form onSubmit={sendChat}>
          <input
            ...
            value={message}  // ✅ Controls the input
